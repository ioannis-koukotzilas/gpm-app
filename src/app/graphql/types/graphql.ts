...
/** The payload for the createVehicle mutation. */
...
/** Input for the deleteVehicle mutation. */
...
/** The payload for the deleteVehicle mutation. */
...
export type MenuItemObjectUnion = Category | Page | Post | Service | Tag | Vehicle;
...
/** The root mutation */
export type RootMutationCreateVehicleArgs = {
...
/** The root mutation */
export type RootMutationDeleteVehicleArgs = {
...
/** The root mutation */
export type RootMutationUpdateVehicleArgs = {
...
export type RootQuery = {
  ...
  /** An object of the vehicle Type.  */
  vehicle: Maybe<Vehicle>;
  /**
   * A vehicle object
   * @deprecated Deprecated in favor of using the single entry point for this type with ID and IDType fields. For example, instead of postBy( id: &quot;&quot; ), use post(id: &quot;&quot; idType: &quot;&quot;)
   */
  vehicleBy: Maybe<Vehicle>;
  /** Connection between the RootQuery type and the vehicle type */
  vehicles: Maybe<RootQueryToVehicleConnection>;
...
/** The root entry point into the Graph */
export type RootQueryVehicleArgs = {
  asPreview: InputMaybe<Scalars['Boolean']['input']>;
  id: Scalars['ID']['input'];
  idType: InputMaybe<VehicleIdType>;
};


/** The root entry point into the Graph */
export type RootQueryVehicleByArgs = {
  id: InputMaybe<Scalars['ID']['input']>;
  slug: InputMaybe<Scalars['String']['input']>;
  uri: InputMaybe<Scalars['String']['input']>;
...
/** The root entry point into the Graph */
export type RootQueryVehiclesArgs = {
  after: InputMaybe<Scalars['String']['input']>;
  before: InputMaybe<Scalars['String']['input']>;
  first: InputMaybe<Scalars['Int']['input']>;
  last: InputMaybe<Scalars['Int']['input']>;
  where: InputMaybe<RootQueryToVehicleConnectionWhereArgs>;
};
...
/** Connection between the RootQuery type and the vehicle type */
export type RootQueryToVehicleConnection = Connection & VehicleConnection & {
  __typename?: 'RootQueryToVehicleConnection';
  /** Edges for the RootQueryToVehicleConnection connection */
  edges: Array<RootQueryToVehicleConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Vehicle>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToVehicleConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToVehicleConnectionEdge = Edge & VehicleConnectionEdge & {
  __typename?: 'RootQueryToVehicleConnectionEdge';
  /** A cursor for use in pagination */
  cursor: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Vehicle;
...
/** Pagination metadata specific to &quot;RootQueryToVehicleConnection&quot; collections. Provides cursors and flags for navigating through sets of RootQueryToVehicleConnection Nodes. */
export type RootQueryToVehicleConnectionPageInfo = PageInfo & VehicleConnectionPageInfo & WpPageInfo & {
  __typename?: 'RootQueryToVehicleConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the RootQueryToVehicleConnection connection */
export type RootQueryToVehicleConnectionWhereArgs = {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author: InputMaybe<Scalars['Int']['input']>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn: InputMaybe<Array<InputMaybe<Scalars['ID']['input']>>>;
...
/** The service type */
export type Service = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithAuthor & NodeWithContentEditor & NodeWithExcerpt & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & WithAcfServiceFields & {
  __typename?: 'Service';
  /**
   * The ancestors of the content node.
   * @deprecated This content type is not hierarchical and typically will not have ancestors
...
/** The service type */
export type ServiceExcerptArgs = {
  format: InputMaybe<PostObjectFieldFormatEnum>;
};
...
export type ServiceFields = AcfFieldGroup & AcfFieldGroupFields & ServiceFields_Fields & {
   ...
   */
  fieldGroupName: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;ServiceFields&quot; Field Group */
...
/** The payload for the updateVehicle mutation. */
...
export type User = Commenter & DatabaseIdentifier & Node & UniformResourceIdentifiable & {
  ...
  /** Connection between the User type and the vehicle type */
  vehicles: Maybe<UserToVehicleConnection>;
};
...
export type UserVehiclesArgs = {
  ...
  first: InputMaybe<Scalars['Int']['input']>;
  last: InputMaybe<Scalars['Int']['input']>;
  where: InputMaybe<UserToVehicleConnectionWhereArgs>;
};
...
/** Pagination metadata specific to &quot;UserToServiceConnection&quot; collections. Provides cursors and flags for navigating through sets of UserToServiceConnection Nodes. */
...
/** Connection between the User type and the vehicle type */
export type UserToVehicleConnection = Connection & VehicleConnection & {
  __typename?: 'UserToVehicleConnection';
  /** Edges for the UserToVehicleConnection connection */
  edges: Array<UserToVehicleConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Vehicle>;
  /** Information about pagination in a connection. */
  pageInfo: UserToVehicleConnectionPageInfo;
};

/** An edge in a connection */
export type UserToVehicleConnectionEdge = Edge & VehicleConnectionEdge & {
  __typename?: 'UserToVehicleConnectionEdge';
  /** A cursor for use in pagination */
  cursor: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Vehicle;
...
/** Pagination metadata specific to &quot;UserToVehicleConnection&quot; collections. Provides cursors and flags for navigating through sets of UserToVehicleConnection Nodes. */
export type UserToVehicleConnectionPageInfo = PageInfo & VehicleConnectionPageInfo & WpPageInfo & {
  __typename?: 'UserToVehicleConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the UserToVehicleConnection connection */
export type UserToVehicleConnectionWhereArgs = {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author: InputMaybe<Scalars['Int']['input']>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn: InputMaybe<Array<InputMaybe<Scalars['ID']['input']>>>;
...
/** The vehicle type */
export type Vehicle = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithAuthor & NodeWithContentEditor & NodeWithExcerpt & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & WithAcfVehicleFields & {
  __typename?: 'Vehicle';
  /**
   * The ancestors of the content node.
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
  ancestors: Maybe<VehicleToVehicleConnection>;
  /** Connection between the NodeWithAuthor type and the User type */
  author: Maybe<NodeWithAuthorToUserConnectionEdge>;
  /** The database identifier of the author of the node */
  authorDatabaseId: Maybe<Scalars['Int']['output']>;
  ...
  /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
  guid: Maybe<Scalars['String']['output']>;
  /** Whether the vehicle object is password protected. */
  hasPassword: Maybe<Scalars['Boolean']['output']>;
  /** The globally unique identifier of the vehicle object. */
  id: Scalars['ID']['output'];
  /** Whether the node is a Comment */
  isComment: Scalars['Boolean']['output'];
  /** Whether the node is a Content Node */
   ...
   * @deprecated This content type is not hierarchical and typically will not have a parent
   */
  parent: Maybe<VehicleToParentConnectionEdge>;
  /** The password for the vehicle object. */
  password: Maybe<Scalars['String']['output']>;
  /** Connection between the Vehicle type and the vehicle type */
  preview: Maybe<VehicleToPreviewConnectionEdge>;
  /** The database id of the preview node */
  previewRevisionDatabaseId: Maybe<Scalars['Int']['output']>;
  /** Whether the object is a node in the preview state */
  previewRevisionId: Maybe<Scalars['ID']['output']>;
  ...
  /** The unique resource identifier path */
  uri: Maybe<Scalars['String']['output']>;
  /** Fields of the VehicleFields ACF Field Group */
  vehicleFields: Maybe<VehicleFields>;
  /**
   * The id field matches the WP_Post-&gt;ID field.
   * @deprecated Deprecated in favor of the databaseId field
   */
...
/** The vehicle type */
export type VehicleAncestorsArgs = {
  after: InputMaybe<Scalars['String']['input']>;
  before: InputMaybe<Scalars['String']['input']>;
  first: InputMaybe<Scalars['Int']['input']>;
  last: InputMaybe<Scalars['Int']['input']>;
...
/** The vehicle type */
export type VehicleContentArgs = {
  format: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The vehicle type */
export type VehicleEnqueuedScriptsArgs = {
  after: InputMaybe<Scalars['String']['input']>;
  before: InputMaybe<Scalars['String']['input']>;
  first: InputMaybe<Scalars['Int']['input']>;
  last: InputMaybe<Scalars['Int']['input']>;
...
/** The vehicle type */
export type VehicleEnqueuedStylesheetsArgs = {
  after: InputMaybe<Scalars['String']['input']>;
  before: InputMaybe<Scalars['String']['input']>;
  first: InputMaybe<Scalars['Int']['input']>;
  last: InputMaybe<Scalars['Int']['input']>;
...
/** The vehicle type */
export type VehicleExcerptArgs = {
  format: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The vehicle type */
export type VehicleTitleArgs = {
  format: InputMaybe<PostObjectFieldFormatEnum>;
};

/** A paginated collection of vehicle Nodes, Supports cursor-based pagination and filtering to efficiently retrieve sets of vehicle Nodes */
export type VehicleConnection = {
  /** A list of edges (relational context) between RootQuery and connected vehicle Nodes */
  edges: Array<VehicleConnectionEdge>;
  /** A list of connected vehicle Nodes */
  nodes: Array<Vehicle>;
  /** Information about pagination in a connection. */
  pageInfo: VehicleConnectionPageInfo;
};

/** Represents a connection to a vehicle. Contains both the vehicle Node and metadata about the relationship. */
export type VehicleConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor: Maybe<Scalars['String']['output']>;
  /** The connected vehicle Node */
  node: Vehicle;
};

/** Pagination metadata specific to &quot;VehicleConnectionEdge&quot; collections. Provides cursors and flags for navigating through sets of &quot;VehicleConnectionEdge&quot; Nodes. */
export type VehicleConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** The &quot;VehicleFields&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type VehicleFields = AcfFieldGroup & AcfFieldGroupFields & VehicleFields_Fields & {
   ...
   */
  fieldGroupName: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;VehicleFields&quot; Field Group */
  passengerCapacity: Maybe<Scalars['String']['output']>;
};

/** Interface representing fields of the ACF &quot;VehicleFields&quot; Field Group */
export type VehicleFields_Fields = {
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
...
/** Identifier types for retrieving a specific Vehicle. Specifies which unique attribute is used to find an exact Vehicle. */
...
/** Connection between the Vehicle type and the vehicle type */
export type VehicleToParentConnectionEdge = Edge & OneToOneConnection & VehicleConnectionEdge & {
  __typename?: 'VehicleToParentConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor: Maybe<Scalars['String']['output']>;
  /**
   * The node of the connection, without the edges
...
/** Connection between the Vehicle type and the vehicle type */
export type VehicleToPreviewConnectionEdge = Edge & OneToOneConnection & VehicleConnectionEdge & {
  __typename?: 'VehicleToPreviewConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: Vehicle;
...
/** Connection between the Vehicle type and the vehicle type */
export type VehicleToVehicleConnection = Connection & VehicleConnection & {
  __typename?: 'VehicleToVehicleConnection';
  /** Edges for the VehicleToVehicleConnection connection */
  edges: Array<VehicleToVehicleConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Vehicle>;
  /** Information about pagination in a connection. */
  pageInfo: VehicleToVehicleConnectionPageInfo;
};

/** An edge in a connection */
export type VehicleToVehicleConnectionEdge = Edge & VehicleConnectionEdge & {
  __typename?: 'VehicleToVehicleConnectionEdge';
  /**
   * A cursor for use in pagination
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
...
/** Pagination metadata specific to &quot;VehicleToVehicleConnection&quot; collections. Provides cursors and flags for navigating through sets of VehicleToVehicleConnection Nodes. */
export type VehicleToVehicleConnectionPageInfo = PageInfo & VehicleConnectionPageInfo & WpPageInfo & {
  __typename?: 'VehicleToVehicleConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Provides access to fields of the &quot;VehicleFields&quot; ACF Field Group via the &quot;vehicleFields&quot; field */
export type WithAcfVehicleFields = {
  /** Fields of the VehicleFields ACF Field Group */
  vehicleFields: Maybe<VehicleFields>;
};
...
export type GetServicesQuery = { __typename?: 'RootQuery', services: { __typename?: 'RootQueryToServiceConnection', nodes: Array<{ __typename?: 'Service', databaseId: number, slug: string | null, title: string | null, excerpt: string | null, content: string | null, featuredImage: { __typename?: 'NodeWithFeaturedImageToMediaItemConnectionEdge', node: { __typename?: 'MediaItem', srcSet: string | null } } | null }> } | null };
...
export type GetServiceBySlugQuery = { __typename?: 'RootQuery', service: { __typename?: 'Service', databaseId: number, slug: string | null, title: string | null, excerpt: string | null, content: string | null, featuredImage: { __typename?: 'NodeWithFeaturedImageToMediaItemConnectionEdge', node: { __typename?: 'MediaItem', srcSet: string | null } } | null, serviceFields: { __typename?: 'ServiceFields', summaryTitle: string | null } | null } | null };

export type GetFeaturedServicesQueryVariables = Exact<{
  notIn: InputMaybe<Array<Scalars['ID']['input']> | Scalars['ID']['input']>;
}>;


export type GetFeaturedServicesQuery = { __typename?: 'RootQuery', services: { __typename?: 'RootQueryToServiceConnection', nodes: Array<{ __typename?: 'Service', databaseId: number, slug: string | null, title: string | null, excerpt: string | null, content: string | null, featuredImage: { __typename?: 'NodeWithFeaturedImageToMediaItemConnectionEdge', node: { __typename?: 'MediaItem', srcSet: string | null } } | null }> } | null };

export type GetVehiclesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetVehiclesQuery = { __typename?: 'RootQuery', vehicles: { __typename?: 'RootQueryToVehicleConnection', nodes: Array<{ __typename?: 'Vehicle', databaseId: number, slug: string | null, title: string | null, featuredImage: { __typename?: 'NodeWithFeaturedImageToMediaItemConnectionEdge', node: { __typename?: 'MediaItem', srcSet: string | null } } | null, vehicleFields: { __typename?: 'VehicleFields', passengerCapacity: string | null } | null }> } | null };
...
export const GetServiceBySlugDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"getServiceBySlug"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"slug"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"service"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"slug"}}},{"kind":"Argument","name":{"kind":"Name","value":"idType"},"value":{"kind":"EnumValue","value":"SLUG"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"databaseId"}},{"kind":"Field","name":{"kind":"Name","value":"slug"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"excerpt"}},{"kind":"Field","name":{"kind":"Name","value":"content"}},{"kind":"Field","name":{"kind":"Name","value":"featuredImage"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"node"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"srcSet"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"serviceFields"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"summaryTitle"}}]}}]}}]}}]} as unknown as DocumentNode<GetServiceBySlugQuery, GetServiceBySlugQueryVariables>;
export const GetFeaturedServicesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"getFeaturedServices"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"notIn"}},"type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"services"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"notIn"},"value":{"kind":"Variable","name":{"kind":"Name","value":"notIn"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"databaseId"}},{"kind":"Field","name":{"kind":"Name","value":"slug"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"excerpt"}},{"kind":"Field","name":{"kind":"Name","value":"content"}},{"kind":"Field","name":{"kind":"Name","value":"featuredImage"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"node"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"srcSet"}}]}}]}}]}}]}}]}}]} as unknown as DocumentNode<GetFeaturedServicesQuery, GetFeaturedServicesQueryVariables>;
export const GetVehiclesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"getVehicles"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"vehicles"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"databaseId"}},{"kind":"Field","name":{"kind":"Name","value":"slug"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"featuredImage"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"node"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"srcSet"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"vehicleFields"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"passengerCapacity"}}]}}]}}]}}]}}]} as unknown as DocumentNode<GetVehiclesQuery, GetVehiclesQueryVariables>;